...
This project implements the idea of PaintRL, the original paper can be found [here](https://sim2real.github.io/assets/papers/kiemel.pdf). The code of the simulation part can be found in the folder `PaintRLEnv`, while the RL training scripts are located in the main folder.
